  ...
  const updateStoreInfo = () => {
    ...
    Api.send3("store_guide_update", param, param2, (args: any) => {
      ...
      if (resultItem.result === "Y") {
        ...
        if (storeInit) {
          setToastState({
            msg: "매장소개를 수정하는 중에 오류가 발생하였습니다.\n관리자에게 문의해주세요.",
            severity: "error",
          });
          handleOpenAlert();
        } else {
          setToastState({
            msg: "매장소개를 등록하는 중에 오류가 발생하였습니다.\n관리자에게 문의해주세요.",
            severity: "error",
          });
          handleOpenAlert();
        }
        ...
        >
          ...
          <Grid container spacing={3}>
                ...
                {detailImgs01 ? (
                  ...
                  >
                    ...
                    <Box
                      ...
                      onClick={() => deleteItemImg(0)}
                    >
                      <img
                        src="images/close_wh.png"
                        style={{
                          position: "absolute",
                          top: 5,
                          right: 5,
            ...
            <Grid item xs={12} md={6}>
              <TextField
                value={
                  ...
                  info.do_jumju_introduction === undefined
                    ? ""
            ...
            <Grid item xs={12} md={6}>
              <TextField
                value={
                  info.do_delivery_guide === null ||
                  info.do_delivery_guide === undefined
                    ? ""
                    : info.do_delivery_guide
                }
                fullWidth
                className={base.multiTxtField}
                id="outlined-multiline-static"
            ...
            <Grid item xs={12} md={6}>
              <TextField
                value={
                  info.do_jumju_menu_info === null ||
                  info.do_jumju_menu_info === undefined
                    ? ""
                    : info.do_jumju_menu_info
                }
                fullWidth
                className={base.multiTxtField}
                id="outlined-multiline-static"
            ...
            <Grid item xs={12} md={6}>
              <TextField
                value={
                  info.do_major_menu === null ||
                  info.do_major_menu === undefined
                    ? ""
                    : info.do_major_menu
                }
                fullWidth
              ...
              <Typography variant="caption" color="primary">
                ※ 대표메뉴가 여러개일 경우, 쉼표(,)로 구분하여 입력해주세요.
              </Typography>
              <div style={{ marginTop: 10, marginBottom: 20 }}></div>
              <TextField
                value={
                  info.do_jumju_origin === null ||
                  info.do_jumju_origin === undefined
                    ? ""
                    : info.do_jumju_origin
                }
                fullWidth
                className={base.multiTxtField}
                id="outlined-multiline-static"
            ...
            <Grid item xs={12} md={6}>
              <TextField
                value={
                  info.do_delivery_time === null ||
                  info.do_delivery_time === undefined
                    ? ""
                    : info.do_delivery_time
                }
                fullWidth
                id="outlined-basic"
                label="평균 배달시간"
            ...
            <Grid item xs={12} md={6}>
              <TextField
                value={
                  info.do_cooking_time === null ||
                  info.do_cooking_time === undefined
                    ? ""
                    : info.do_cooking_time
                }
                fullWidth
                id="outlined-basic"
                label="평균 조리시간"
