          ...
          {lists && lists.length > 0 && (
            <Grid container spacing={3} style={{ minHeight: 520 }}>
              {lists.map((list, index) => (
                ...
                >
                  <Paper
                    className={clsx(base.paper, coupon.gradient)}
                    style={{
                      textAlign: "left",
                      borderWidth: 1,
                      borderStyle: "dotted",
                  ...
                  >
                    ...
                    <Box display="flex" flexDirection="row">
                      ...
                      <Typography
                        ...
                        component="p"
                        style={{ fontSize: 13 }}
                      >{`${list.cz_start} - ${list.cz_end}`}</Typography>
                    </Box>
