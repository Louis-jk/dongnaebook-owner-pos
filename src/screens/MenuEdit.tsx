        ...
        >
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <Box mb={3}>
                <small>
                  업로드 가능한 이미지 확장자는 <mark>jpg, jpeg, png, bmp</mark>
                  입니다.
                </small>
                {!imageUsable && (
                  <>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>
                {`선택하신 ${
                  mainOptionType === "default" ? "기본옵션" : "추가옵션"
                }을 삭제하시겠습니까?`}
              </DialogContentText>
            </DialogContent>
            <DialogActions>
