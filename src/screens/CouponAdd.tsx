...
export default function CouponAdd() {
  ...
  const addCouponConfirmHandler = () => {
    ...
    // }
      ...
      setToastState({
        msg: "다운로드 유효기간 시작날짜를 지정해주세요.",
        severity: "error",
      });
      handleOpenAlert();
    } else if (value[1] === null) {
      setToastState({
        msg: "다운로드 유효기간 종료날짜를 지정해주세요.",
        severity: "error",
      });
      handleOpenAlert();
          ...
          <div className={base.modalInner}>
            ...
            <ButtonGroup variant="text" aria-label="text primary button group">
              <ModalConfirmButton
                ...
                onClick={reAddHandler}
              >
                추가 등록하기
              </ModalConfirmButton>
              <ModalCancelButton variant="outlined" onClick={goBackList}>
                아니요
              </ModalCancelButton>
            </ButtonGroup>
          </div>
