...
const PrintModal = (props: any) => {
  const { mt_store, do_jumju_origin_use } = useSelector(
    (state: any) => state.login
  );
  const { order, product, store } = useSelector(
    ...
    let data = {
      ...
      orderContactNumber:
        order.order_safety_number && order.od_settle_type !== "cash"
          ? `${order.order_safety_number}${order.order_safety_str}`
          : Api.phoneFomatter(order.order_hp).toString(),
      requestToStore: order.order_seller
        ? order.order_seller
        : "요청사항이 없습니다.",
      requestToOfficer: order.order_officer
        ? order.order_officer
        : "요청사항이 없습니다.",
      requestToItem:
        order.od_no_spoon === "1" || order.od_no_spoon === 1
          ? "필요없음"
          : "필요함",
      orderMenus: product,
      ...
      orderDateTime: `${moment(order.od_time, "YYYY-MM-DD HH:mm:ss").format(
        "YYYY. MM. DD  HH:mm"
      )}`,
  ...
  //         <tr>
  //           <td style='text-align: left; font-size: 11pt; font-weight: bold; letter-spacing: -1;'>주문번호 : ${
  //             order.order_id
  //           }</td>
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 11pt; font-weight: bold; letter-spacing: -1;'>결제방식 : ${
  ...
  //       <table style='width: 100%; border-collapse: collapse; border-spacing: 0;'>
  //         <tr>
  //           <td style='text-align: left; font-size: 8pt; letter-spacing: -1;'>${
  //             order.od_type
  //           }주소</td>
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 11pt; font-weight: bold; letter-spacing: -1;'>${
  //             order.order_addr1
  //           }${order.order_addr3}</td>
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 8pt; letter-spacing: -1;'>${
  //             order.od_addr_jibeon
  //           }</td>
  //         </tr>
  //       </table>
  //       <div style='display: width: 100%; border: 0.15pt solid black; margin: 5px 0;'></div>
  ...
  //           </tr>`
  //             : `<tr>
  //             <td style='text-align: left; font-size: 11pt; letter-spacing: -1; font-weight: bold;'>${Api.phoneFomatter(
  //               order.order_hp
  //             )}</td>
  //           </tr>`
  //         }
  ...
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 11pt; font-weight: bold; letter-spacing: -1;'>가게 : ${
  //             order.order_seller ? order.order_seller : "요청사항이 없습니다."
  //           }</td>
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 11pt; font-weight: bold; letter-spacing: -1;'>배달 : ${
  //             order.order_officer ? order.order_officer : "요청사항이 없습니다."
  //           }</td>
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 11pt; font-weight: bold; letter-spacing: -1;'>일회용 수저, 포크 : ${
  //             order.od_no_spoon == "1" ? "필요없음" : "필요함"
  //           }</td>
  //         </tr>
  //       </table>
  //       <div style='display: width: 100%; border: 0.15pt solid black; margin: 5px 0;'></div>
  ...
  //             <td style='text-align: left; font-size: 11pt; letter-spacing: -1; font-weight: bold;'>${
  //               menu.it_name
  //             } ${menu.ct_qty}개</td>
  //             <td style='text-align: right; font-size: 11pt; letter-spacing: -1; font-weight: bold;'>${Api.comma(
  //               menu.sum_price
  //             )}원</td>
  //           </tr>
  //           ${
  ...
  //               ? menu.cart_option
  //                   .map(
  //                     (defaultOption: any, key: number) =>
  //                       `<tr key=${"defaultOption-name-" + key}>
  //               <td style='text-align: left; font-size: 7pt; letter-spacing: -1; font-weight: bold;'>└ 기본옵션 : ${
  //                 defaultOption.ct_option
  //               }</td>
  //             </tr>
  //             <tr key=${"defaultOption-price-" + key}>
  //               <td style='text-align: left; font-size: 7pt; letter-spacing: -1; font-weight: bold;'>└ 옵션금액 : ${Api.comma(
  //                 defaultOption.io_price
  //               )}원</td>
  //             </tr>
  //             `
  //                   )
  ...
  //           }
  //         ${
  //           menu.cart_add_option && menu.cart_add_option.length > 0
  //             ? menu.cart_add_option
  //                 .map(
  //                   (addOption: any, key: number) =>
  //                     `<tr key=${"addOption-name-" + key}>
  //               <td style='text-align: left; font-size: 7pt; letter-spacing: -1; font-weight: bold;'>└ 추가옵션 : ${
  //                 addOption.ct_option
  //               }</td>
  //             </tr>
  ...
  //       <table style='width: 100%; border-collapse: collapse; border-spacing: 0;'>
  //         <tr>
  //           <td style='text-align: left; font-size: 8pt; letter-spacing: -1;'>주문매장 : ${
  //             store.mb_company
  //           }</td>
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 8pt;'>주문번호 : ${
  //             order.order_id
  //           }</td>
  //         </tr>
  //         <tr>
  //           <td style='text-align: left; font-size: 8pt;'>주문일시 : ${moment(
  //             order.od_time,
  //             "YYYY-MM-DD HH:mm:ss"
  ...
  //     </style>
  //     <div class='print_area' style='width: 100%;'>
  //       <h5 style='text-align: center; font-size: 14pt; font-weight: bold; margin-bottom: 15px'>${
  //         order.od_type
  //       } 주문전표</h5>
  //       <table style='width: 100%; border-collapse: collapse; border-spacing: 0;'>
  //         <tr>
          ...
          <Box display="flex" flexDirection="column">
            <div className="print_no_area" style={{ zIndex: 99999 }}>
              ...
              >
                ...
                <IconButton className="no-drag-area" onClick={printHandler}>
                  <PrintIcon color="info" />
                </IconButton>
                <IconButton onClick={props.isClose}>
            ...
            {mt_store && order && product && store ? (
              ...
              >
                ...
                <Typography fontSize="11pt" fontWeight="bold">
                  주문번호 : {order.order_id}
                </Typography>
                <Typography mb={1} fontSize="11pt" fontWeight="bold">
                  결제방식 : {order.od_settle_case}
                </Typography>
                <Divider />
                <Box my={1}>
                  <Box display="flex" flexDirection="column">
                    <Typography mb={0.5} fontSize="10pt">
                      {order.od_type}주소
                    </Typography>
                    <Typography
                      mb={order.od_addr_jibeon ? 0.5 : 0}
                      fontSize="11pt"
                      fontWeight="bold"
                    >
                ...
                <Box my={1}>
                  <Box display="flex" flexDirection="column">
                    ...
                    order.od_settle_type !== "cash" ? (
                      <>
                        <Typography mb={0.5} fontSize="12pt" fontWeight="bold">
                          {order.order_safety_number}
                        </Typography>
                        <Typography fontSize="10pt">
                          {order.order_safety_str}
                        </Typography>
                      </>
                    ) : (
                      <Typography fontSize="12pt" fontWeight="bold">
                ...
                <Box my={1}>
                  ...
                  >
                    <Box flex="5">
                      <Typography textAlign="left" fontSize="10pt">
                        메뉴명
                      </Typography>
                    </Box>
                    {/* <Box flex="1">
                    ...
                    <Box flex="2">
                      <Typography textAlign="right" fontSize="10pt">
                        금액
                      </Typography>
                    </Box>
                  </Box>
                      ...
                      <Box mb={1}>
                        ...
                        >
                          {menu.cart_option &&
                            ...
                            menu.cart_option.map(
                              (defaultOption: any, key: number) => (
                                <Box
                                  mb={
                                    key === menu.cart_option.length - 1 ? 0 : 1
                                  }
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      옵션금액:{" "}
                                      {Api.comma(defaultOption.io_price)}원
                                    </Typography>
                                  </Box>
                                </Box>
                              )
                        ...
                        {menu.cart_add_option &&
                          menu.cart_add_option.length > 0 &&
                          menu.cart_add_option.map(
                            (addOption: any, key: number) => (
                              <Box
                                mb={
                                  key === menu.cart_add_option.length - 1
                                    ? 0
                                    : 1
                                }
                                key={`addOption-${key}`}
                ...
                <Box mt={1.5} mb={1}>
                  ...
                  <Box display="flex" flexDirection="row" mb={0.5}>
                    ...
                    <Typography
                      ...
                      textAlign="right"
                    >
                      {Api.comma(order.order_coupon_ohjoo)}원
                    </Typography>
                  </Box>
                  <Box display="flex" flexDirection="row" mb={1}>
                    <Typography
                    ...
                    <Typography
                      ...
                      textAlign="right"
                    >
                      {Api.comma(order.order_coupon_store)}원
                    </Typography>
                  </Box>
                ...
                <Box my={1}>
                  <Box display="flex" flexDirection="column">
                    ...
                    <Typography fontSize="10pt">
                      주문일시 :{" "}
                      {moment(order.od_time, "YYYY-MM-DD HH:mm:ss").format(
                        "YYYY.MM.DD HH:mm"
                      )}
                    </Typography>
                  </Box>
