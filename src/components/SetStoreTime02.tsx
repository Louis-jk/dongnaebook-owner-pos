  ...
  return isLoading ? (
    ...
    <Box component="section">
          ...
          <Box className={clsx(base.modalInner, base.colCenter)}>
            ...
            >
              <ModalConfirmButton
                ...
                onClick={() => addStoreClosingDay("all")}
              >
                전체 매장에 적용
              </ModalConfirmButton>
              <ModalConfirmButton
                ...
                onClick={() => addStoreClosingDay("curr")}
              >
                해당 매장만
              </ModalConfirmButton>
              <ModalCancelButton
          ...
          >
            <Box className={base.flexRowStartCenter}>
              ...
              >
                ...
                <p className={base.mr20}>{list.st_yoil_txt}</p>
              </Box>
            </Box>
            <IconButton
              color="primary"
              ...
              onClick={deleteStoreClosingDayHandler}
            >
      ...
      {list ? (
        <Typography
          className={base.mb10}
          style={{ color: "#999", margin: "25px 0 10px" }}
        >
          정기 휴무 요일과 주가 설정되어 있습니다.
        </Typography>
      ) : (
        <Typography
            ...
            weekArr.map((week, index) => (
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    style={{
                      color: list ? "#e5e5e5" : theme.palette.primary.main,
                    }}
                  />
                }
                label={week.value}
