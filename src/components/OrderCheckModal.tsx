...
export default function OrderCheckModal(props: IProps) {
  const { mt_id, mt_jumju_code, mt_print, do_jumju_origin_use } = useSelector(
  ...
  const checkOrderHandler = () => {
    if (deliveryTime === "") {
      if (props.od_type === "포장") {
        setToastState({
          msg: "포장 완료 예상시간을 입력해주세요.",
          severity: "error",
        });
      } else {
        setToastState({
          msg: "배달 예상 소요시간을 입력해주세요.",
          severity: "error",
        });
      }
      handleOpenAlert();
      ...
      >
        <Fade in={props.isOpen}>
          <Box className={clsx(base.modalInner, base.colCenter)}>
            ...
            >{`${
              props.od_type === "포장" ? "포장" : "배달"
            } 예상시간 등록`}</Typography>
            <Typography id="transition-modal-description">{`${
              props.od_type === "포장" ? "포장" : "배달"
            } 예상시간을 입력해주세요.`}</Typography>
            <TextField
              value={deliveryTime}
            ...
            <Box display="flex" flexDirection="row" mb={5}>
              <Button
                variant={deliveryTime === "10" ? "contained" : "outlined"}
                color="info"
                style={{ marginRight: 5, boxShadow: "none" }}
                onClick={() => setDeliveryTime("10")}
              >
                10분
              </Button>
              <Button
                variant={deliveryTime === "20" ? "contained" : "outlined"}
                color="info"
                style={{ marginRight: 5, boxShadow: "none" }}
                onClick={() => setDeliveryTime("20")}
              >
                20분
              </Button>
              <Button
                variant={deliveryTime === "30" ? "contained" : "outlined"}
                color="info"
                style={{ marginRight: 5, boxShadow: "none" }}
              ...
              <Button
                variant={deliveryTime === "40" ? "contained" : "outlined"}
                color="info"
                style={{ marginRight: 5, boxShadow: "none" }}
                onClick={() => setDeliveryTime("40")}
              >
                40분
              </Button>
              <Button
                variant={deliveryTime === "50" ? "contained" : "outlined"}
                color="info"
                style={{ marginRight: 5, boxShadow: "none" }}
                onClick={() => setDeliveryTime("50")}
              >
                50분
              </Button>
              <Button
                variant={deliveryTime === "60" ? "contained" : "outlined"}
                color="info"
